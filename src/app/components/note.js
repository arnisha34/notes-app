    ...
    <div className="w-full mx-auto">
      <div id="main-section" className="flex h-screen">
        <section className="border-r-1 border-gray-400 flex flex-col p-5 w-xs">
          ...
          {!ctx.activeNote&&
          <div className={`${ctx.activeNote ?"hidden":""} bg-neutral-100 flex flex-col gap-3 items-center p-3 rounded-lg text-sm dark:bg-slate-800 dark:text-slate-400"}`}><PencilSquareIcon className="text-gray-500 w-8 dark:text-slate-400"/>You haven&apos;t added any notes yet. Begin a new note to jot down your thoughts and ideas.</div>}
          <SavedNotes />
        </section>
